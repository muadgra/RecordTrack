...
namespace RecordTrack.Persistance.Migrations
{
    ...
    [Migration("20220806074104_mig_8")]
    partial class mig_8
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecordTrack.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("RecordTrack.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("RecordTrack.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecordTrack.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
